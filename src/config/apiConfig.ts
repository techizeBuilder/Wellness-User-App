...
export const ENDPOINTS = {
  AUTH: {
    ...
    REQUEST_PASSWORD_RESET_OTP: '/auth/request-password-reset-otp',
  ...
  BOOKINGS: {
    ...
    EXPERT_GROUP_SESSION: '/bookings/expert/group-session',
...
export const API_URLS = {
  AUTH: {
    ...
    REQUEST_PASSWORD_RESET_OTP: buildUrl(ENDPOINTS.AUTH.REQUEST_PASSWORD_RESET_OTP),
    VERIFY_PASSWORD_RESET_OTP: buildUrl(ENDPOINTS.AUTH.VERIFY_PASSWORD_RESET_OTP),
    RESET_PASSWORD_WITH_OTP: buildUrl(ENDPOINTS.AUTH.RESET_PASSWORD_WITH_OTP),
  ...
  BOOKINGS: {
    ...
    EXPERT_GROUP_SESSION: buildUrl(ENDPOINTS.BOOKINGS.EXPERT_GROUP_SESSION),
