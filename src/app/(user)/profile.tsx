...
const styles = StyleSheet.create({
  ...
  profileSection: {
    alignItems: 'center',
    paddingVertical: getResponsivePadding(screenData.isSmall ? 12 : 16),
    marginHorizontal: 0,
    marginTop: 0,
  },
  ...
  editButton: {
    ...
    bottom: 0,
    right: 0,
    width: getResponsiveWidth(screenData.isSmall ? 36 : 40),
    height: getResponsiveHeight(screenData.isSmall ? 36 : 40),
    borderRadius: getResponsiveBorderRadius(screenData.isSmall ? 18 : 20),
  ...
  statusIndicator: {
    ...
    alignItems: 'center',
    justifyContent: 'center',
    minWidth: getResponsiveWidth(50),
  },
  statusEnabled: {
